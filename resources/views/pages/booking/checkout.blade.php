...
<div class="flex flex-col gap-4 pt-[22px]">
    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-3">
            ...
            <p class="text-ngekos-grey">Nomor Ponsel</p>
        </div>
...
<form action="{{ route('booking.payment', $boardingHouse->slug)}}" 
    class="relative flex flex-col gap-6 mt-5 pt-5" method="POST">
    @csrf
<div id="PaymentOptions" class="flex flex-col rounded-[30px] border border-[#F1F2F6] p-5 gap-4 mx-5">
    <div id="TabButton-Container"
        ...
        <label class="tab-link group relative flex flex-col justify-between gap-4"
            ...
            <div class="flex items-center gap-3 mx-auto">
                ...
                <p class="font-semibold"><i>Down Payment</i></p>
            </div>
            <div
    ...
    <div id="TabContent-Container">
        ...
        <div id="FullPayment-Tab"

        class="tab-content flex flex-col gap-4 hidden">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <img src="{{ asset('assets/images/icons/receipt-text.svg')}}" class="w-6 h-6 flex shrink-0"
                        alt="icon">
                    <p class="text-ngekos-grey">Total Yang Harus Dibayar</p>
                </div>
    ...
    <div class="fixed bottom-5 w-full max-w-[640px] px-5 z-10">
        <div class="flex items-center justify-between rounded-[40px] py-4 px-6 bg-ngekos-black">
            <div class="flex flex-col gap-[2px]">
                ...
                <span class="text-sm text-white">Total Yang Harus Dibayar</span>
            </div>
            <button type="submit"
                class="flex shrink-0 rounded-full py-[14px] px-5 bg-ngekos-orange font-bold text-white">Bayar
                Sekarang</button>
        </div>
    </div>
</div>
