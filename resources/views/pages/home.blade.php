...
@section('content')
    ...
    <div id="Background"
        ...
        style="background: linear-gradient(180deg, #F2F9E6 0%, #D2EDE4 100%)">
    </div>
    <div id="TopNav" class="relative flex items-center justify-between px-5 mt-[60px]">
        <div class="flex flex-col gap-1">
            <p>Selamat Datang di <b>KOSTOPIA</b></p>
            <h1 class="font-bold text-xl leading-[30px]">Yuk Jelajahi Kos Pilihanmu!</h1>
        </div>
    </div>
    ...
    <section id="Popular" class="flex flex-col gap-4 w-full overflow-x-visible">
        <div class="flex items-center justify-between px-5">
            <h2 class="font-bold">Populer</h2>
            <a href="#">
        ...
        <div class="swiper swiper-popular px-5 overflow-visible w-full">
            <div class="swiper-wrapper">
    ...
    <section id="Cities" class="flex flex-col p-5 gap-4 bg-[#F5F6F8] mt-[30px]">
        <div class="flex items-center justify-between">
            <h2 class="font-bold">Choose Your City</h2>
            <!-- <a href="#">
                <div class="flex items-center gap-2">
                    <span>Lainnya</span>
                    <img src="assets/images/icons/arrow-right.svg" class="w-6 h-6 flex shrink-0" alt="icon">
    ...
    <section id="Best" class="flex flex-col gap-4 px-5 mt-[30px]">
        <div class="flex items-center justify-between">
            <h2 class="font-bold">Top-rated Kost</h2>
            <!-- <a href="#">
                <div class="flex items-center gap-2">
                    <span>Lainnya</span>
                    <img src="assets/images/icons/arrow-right.svg" class="w-6 h-6 flex shrink-0" alt="icon">
