...
class BookingController extends Controller
{
    ...
    public function payment(Request $request)
    {
        ...
        $oldTransactionData = $this->transactionRepository->getTransactionDataFromSession();
        $newTransactionData = array_merge($oldTransactionData, $request->all());
        $this->transactionRepository->saveTransactionDataToSession($newTransactionData);
        $transaction = $this->transactionRepository->saveTransaction($newTransactionData);
        ...
        // BUAT LINK PEMBAYARAN DAN REDIRECT
